...
```bash
# Clone the repo
git clone https://github.com/DomumDigital/ResendCLI.git

# Copy into your Claude Code skills directory
cp -r ResendCLI ~/.claude/skills/ResendCLI
```

Or if you prefer, clone directly into your skills directory:
...
└── references/
    ├── commands.md                 # Full CLI command reference (78 subcommands)
    └── troubleshooting.md          # Diagnostic workflows
```

## Covered commands

13 command groups, 78 subcommands:
